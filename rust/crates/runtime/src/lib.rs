...
pub use conversation::{
    ...
    ToolError, ToolExecutor, TurnObserver, TurnSummary,
};
pub use file_ops::{
...
pub use questions::{
    UserQuestionAnswer, UserQuestionOption, UserQuestionRequest, UserQuestioner,
};
pub use prompt::{
...
pub use session::{
    AttachmentKind, ContentBlock, ConversationMessage, MessageAttachment, MessageRole,
    RetrievedChunk, RetrievedContext, Session, SessionError,
};
pub use usage::{
